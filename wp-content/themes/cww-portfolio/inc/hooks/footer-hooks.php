		...
		<footer id="colophon" class="site-footer">
			...
			<div class="site-info cww-flex">
				...
				<span class="sep"> | </span>
					...
					printf( esc_html__( 'Theme: %1$s by %2$s.', 'cww-portfolio' ), '<a href="https://codeworkweb.com/themes/cww-portfolio" class="th-name">CWW Portfolio</a>', '<a href="https://codeworkweb.com/">Code Work Web</a>' );
					?>
			</div><!-- .site-info -->
			</div>
		</footer><!-- #colophon -->
